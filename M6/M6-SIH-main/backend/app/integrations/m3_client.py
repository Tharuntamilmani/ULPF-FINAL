...
def get_m3_client() -> ModuleClient:
    settings = get_settings()
    if settings.use_mock_adapters:
        return MockModuleClient("m3-normalizer")
    return HttpModuleClient("m3-normalizer", settings.m3_base_url or None)
